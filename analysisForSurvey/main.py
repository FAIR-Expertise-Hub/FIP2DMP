...
data = {
    ...
    'Volunteer 6': [5, 4, 5, (q['4.6'], q['4.8'], q['4.9'], q['4.13'], q['5.2']), (q['5.1'], ), 'no', 4, '6-10 years', 'no', 4, [entities[0], entities[2], entities[3], entities[5], entities[6], entities[7], entities[9], entities[12]], 'none.'],
}
